...
public class MainSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Board_Matching> list=new MainService().selectMemberList(keyword,cPage,numPerPage);
		...
		if(pageNo==1) {
			...
			+"/main/mainFinder?cPage="+(pageNo-1)
		...
		request.getRequestDispatcher("/views/mainList.jsp")
