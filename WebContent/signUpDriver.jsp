          ...
          >
            ...
            <div class="form-group form-group-1">
              ...
              <script language="javascript">
                ...
                document.write("<select name=birth1 style=width:80px class=custom-select-sm>");
                for (i = start; i >= end; i--) document.write("<option value='" + i + "'>" + i);
                document.write("</select><span class=input-dateofbirth-text>Year</span>  ");

                document.write("<select name=birth2 style=width:80px class=custom-select-sm >");
                for (i = 1; i <= 12; i++) document.write("<option value='" + i + "'>" + i);
                document.write("</select><span class=input-dateofbirth-text>Month</span>  ");

                document.write("<select name=birth3 style=width:80px class=custom-select-sm >");
            ...
            <div class="form-group">
              ...
              <select name="carType" style="width:100px;padding:10x" class="custom-select-sm">
