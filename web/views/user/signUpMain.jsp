			...
			<div class="col-xl-10 content-background">
				...
				<form class="form-style" id="sendform" method="post">
					<div class="form-group">
						<label for="phone_number">Input Your Phone Number</label> <input type="text" name="phone_number"
							id="phone_number" class="form-control input-phonenumber" placeholder="010-XXXX-XXXX" />
				</form>
			</div>
			<div class="form-style">	
				<div>
					</form>
					<button onclick="duplicateCheck();" class="btn btn-warning button-send">
