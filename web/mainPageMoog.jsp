<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
        List<BoardMatching> list_page=(List)request.getAttribute("list_page");
 		String selectGu = (String)request.getAttribute("selectGu");
			...
			<div class="col-lg-4 col-md-6 col-sm-8 col-sx-9 col-10 m-auto">
                    <div class="blog-post">
                        <div class="post-thumb">
                            <a href="<%=request.getContextPath()%>/detail?boardNo=<%=bm.getBoardNo()%>"> <!-- hereee -->
                                <!-- 이미지 -->
								<%for(int i = 0 ; i<fileList.size();i++){
									if(fileList.get(i).getBoardNo()==bm.getBoardNo()){%>
										<img src="<%=request.getContextPath()%>/images/boardMatching_images/<%=fileList.get(i).getFileName() %>" class="img-responsive" style="width:360px;height:200px;">
										<%
									break;	
									}}%>
                            </a>
                        ...
                        <div class="post-content">
                            ...
                            <div class="post-title">
                                ...
                                <h2 style="font-size: 0.5rem" class="mb-0 mt-0"><a href="#">
                                <!-- 출발지 도착지 -->
							<%
                            ...
                            <div class="post-meta">
                                <ul class="list-inline">
                                    <li class="list-inline-item">
                                        <a href="<%=request.getContextPath()%>/detail?boardNo=<%=bm.getBoardNo()%>"><%=bm.getWrtier() %></a>
                                    </li>
                                    <li class="list-inline-item">
                                        <a href="<%=request.getContextPath()%>/detail?boardNo=<%=bm.getBoardNo()%>">조회수:<%=bm.getCount() %></a>
                                    </li>
                                    <%if(bm.getMemo()!=null){ %>
                                    <li class="list-inline-item">
                                        <a href="<%=request.getContextPath()%>/detail?boardNo=<%=bm.getBoardNo()%>">메모:<%=bm.getMemo() %></a>
                                    </li>
                                    <%} %>
                                </ul>
                            </div>
